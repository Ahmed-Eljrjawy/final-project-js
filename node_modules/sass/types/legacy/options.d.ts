...
/**
 * Options for {@link renderTasks} and {@link renderSync} that are shared between
...
export interface LegacySharedOptions<sync extends 'sync' | 'async'> {
   ...
   *
   * **Heads up!** If {@link renderTasks} or {@link renderSync} is called without
...
/**
 * Options for {@link renderTasks} and {@link renderSync}. This can either be {@link
